...
if("TRUE" STREQUAL "TRUE")
  set(pathfinder_SOURCE_PREFIX /home/abhibhagwat/catkin_mopla/src/pathfinder)
  set(pathfinder_DEVEL_PREFIX /home/abhibhagwat/catkin_mopla/devel)
  ...
  set(pathfinder_INSTALL_PREFIX /home/abhibhagwat/catkin_mopla/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pathfinder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/abhibhagwat/catkin_mopla/src/pathfinder/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND pathfinder_EXPORTED_TARGETS ${${pathfinder_dep}_EXPORTED_TARGETS})
endforeach()
